...
% THIS SECTION MUST BE CHECKED AND CHANGED 
model_dir = sprintf('%sfmri/2ndLevel/allregressors/',output_path); % MUST BE CHANGED! 
% CHECK IF USING RIGHT CONTRAST
% CHECK IF USING RIGHT COVARIATES 
% CHECK IF RIGHT CONTRASTS SPECIFIED 
